...
public class UpdateMessage implements IMessage {
	...
	BlockPos getPoint() {
		return new BlockPos(point);
	}

	BlockPos getDisplacement() {
		return new BlockPos(displacement);
	}
	
	public UpdateMessage() {}

	public UpdateMessage(BlockPos point, String name, int rotationRender, BlockPos displacement, int operation) {
