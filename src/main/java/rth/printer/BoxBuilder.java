...
public class BoxBuilder implements Printable {
	char mC;
	char sC;
	char lC;
	...
	@Override
	public void construct(BlockPos referenceBlock, EnumFacing playerFacing, EnumFacing blockSide) {
		this.centralBlock = referenceBlock;
		setInitialConditions(playerFacing, blockSide);
		
	}

	@Override
	public void buildAreaToPrint() {
		buildBox();
		
	}

	@Override
	public ArrayList<BlockPos> getBuiltArea() {
		return getBox();
	}
